  ...
  init: function () {
    ...
    if (!this.get('block.storage.searchFilters')) {
      ...
      this.set('block.storage.searchFilters', [
        {
          displayValue: 'Stackoverflow',
          filterValue: 'stackoverflow.com',
          id: 'stackoverflow-checkbox',
          value: true
        },
        {
          displayValue: 'Stackexchange',
          filterValue: 'stackexchange.com',
          id: 'stackexchange-checkbox',
          value: true
        },
        {
          displayValue: 'Serverfault',
          filterValue: 'serverfault.com',
          id: 'serverfault-checkbox',
          value: true
        },
        {
          displayValue: 'Superuser',
          filterValue: 'superuser.com',
